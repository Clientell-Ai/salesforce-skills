...
Use these ready-to-go snippets when submitting PRs to awesome-agent-skills lists.

---

## For VoltAgent/awesome-agent-skills

**PR Title:** Add Salesforce Skills by Clientell (10 skills — Apex, Flows, LWC, SOQL, Security, Deploy)
...
## For heilcheng/awesome-agent-skills
...
## For skillmatic-ai/awesome-agent-skills
...
- [salesforce-skills](https://github.com/clientell/salesforce-skills) - 10 skills covering the full Salesforce development lifecycle. `npx skills add clientell/salesforce-skills`
  ...
  - `sf-lwc` — Lightning Web Components with LDS, navigation, LMS
  - `sf-soql` — SOQL/SOSL with date literals, geolocation, dynamic queries
  - `sf-security` — AppExchange security audit (CRUD/FLS, injection, sharing)
  - `sf-deploy` — Scratch orgs, packages, CI/CD, destructive changes
  - `sf-data` — Bulk API 2.0, external ID upsert, relationship ordering
  - `sf-schema` — All field types, formulas, rollup summaries, Global Value Sets
  - `sf-find` — Skill discovery and routing
```

---

## For philipbankier/awesome-agent-skills
...
After pushing to GitHub, go to repo Settings and add these topics:
